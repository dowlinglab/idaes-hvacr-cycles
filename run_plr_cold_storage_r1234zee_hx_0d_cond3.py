...
from vapor_compression_plr_hx_0d_cond3 import (
    Mode,
    SimpleVaporCompressionCyclePLRHX0DCond3,
)
...
def _build_cycle_r1234ze():
    ...
    for name in candidates:
        try:
            cycle = SimpleVaporCompressionCyclePLRHX0DCond3(
                fluid_name=name,
...
def main():
    ...
    out_csv = "cop_vs_ambient_plr_cold_storage_r1234zee_hx_0d_cond3.csv"
    out_png = "cop_vs_ambient_plr_cold_storage_r1234zee_hx_0d_cond3.png"
    out_pdf = "cop_vs_ambient_plr_cold_storage_r1234zee_hx_0d_cond3.pdf"
    ...
    ax.set_title("R1234ze(E): PLR + HX (IDAES 0D Cond3) vs Carnot")
