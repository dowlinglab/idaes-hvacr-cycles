...
"""Cycle configuration for the HX-lumpedUA variant.

Context
-------
This module belongs to the `cycle_dx_hx_lumpedUA` variant. Relative to baseline
intent, this variant preserves single-zone finite-UA heat exchanger behavior and only
...
class CycleConfig:
    ...
    UA_evap_tp: float = 1000.0
    UA_evap_sh: float = 500.0

    UA_cond_ds: float = 500.0
    UA_cond_tp: float = 1000.0
    UA_cond_sc: float = 300.0
