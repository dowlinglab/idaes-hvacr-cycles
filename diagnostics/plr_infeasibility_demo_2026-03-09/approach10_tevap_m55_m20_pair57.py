...
def main():
    ...
    out_csv = f'{OUT_DIR}/approach10_tevap_m55_m20_pair57_r134a.csv'
    ...
    ax.set_title('Approach=10 C, Tevap_sat in [-55,-20] C, (subcool,superheat)=(5,7)')
    cbar = fig.colorbar(im, ax=ax)
    cbar.set_label('COP (infeasible points masked)')
    fig.tight_layout()

    out_png = f'{OUT_DIR}/approach10_tevap_m55_m20_pair57_r134a.png'
    out_pdf = f'{OUT_DIR}/approach10_tevap_m55_m20_pair57_r134a.pdf'
