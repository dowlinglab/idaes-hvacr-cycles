...
"""Cycle configuration for the HX-zonedUA variant.

Context
-------
This module belongs to the `cycle_dx_hx_zonedUA` variant. Relative to baseline
intent, this variant preserves zoned DX finite-UA heat exchanger behavior and only
