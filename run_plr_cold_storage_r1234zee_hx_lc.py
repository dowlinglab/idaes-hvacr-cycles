...
from vapor_compression_plr_hx_lc import (
    Mode,
    SimpleVaporCompressionCyclePLRHXLC,
)
...
def _build_cycle_r1234ze():
    ...
    for name in candidates:
        try:
            cycle = SimpleVaporCompressionCyclePLRHXLC(
                fluid_name=name,
...
def main():
    ...
    out_csv = "cop_vs_ambient_plr_cold_storage_r1234zee_hx_lc.csv"
    out_png = "cop_vs_ambient_plr_cold_storage_r1234zee_hx_lc.png"
    out_pdf = "cop_vs_ambient_plr_cold_storage_r1234zee_hx_lc.pdf"
