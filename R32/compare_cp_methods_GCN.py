...
METHODS = [
    ...
    {"name": "first_principle", "Pc_bar": 52.54216, "Tc": 397.6136,
     "psat_pa": 338217.0,  # Colon group's "pvap" column, Pa (not mmHg as labeled),
                           # taken as Psat at Tr = 0.7*Tc -- see omega_from_psat() below
     "A": 29.1173, "B": 139.601, "C": 62.8355, "D": 25.3128, "E": -0.000791509},
    {"name": "gcn", "Pc_bar": 62.22664, "Tc": 329.1245,
     "psat_pa": 133784.6,  # same as above
