...
#
# 09/03/2026: retargeted again -- import below repointed to
# phase_1_cubic_eos_validation_refstate_0903, the working file for the
# Colon group's post-thermoreconciliation (4).xlsx delivery. Used by
# phase6_final_0903.py.
#
# 09/09/2026: retargeted again to phase_1_cubic_eos_validation_refstate_0909,
# the working file for the (5).xlsx delivery (Sep-6-revised first_principle/
# gcn, plus new first_principle_multi/gcn_multi methods). Used by
# phase6_final_0909.py.
#
# 09/10/2026: retargeted again (this _0910 copy) to phase_1_cubic_eos_
# validation_refstate_0910, the working file for the (7).xlsx delivery --
# first_principle/gcn/first_principle_multi all got revised Shomate a-e
# fits this round; gcn_multi's fit failed and falls back to the 09/06
# values (see phase_1_cubic_eos_validation_refstate_0910.py's own 09/10
# note for the full comparison). Will be used by phase6_final_0910.py.
#
...
from phase_1_cubic_eos_validation_refstate_0910 import make_config, METHODS
