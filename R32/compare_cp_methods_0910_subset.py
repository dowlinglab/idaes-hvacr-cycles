...
Also added plt.savefig() calls for both diagrams (ph_diagram_0910_NIST_GCGP_fp.png,
ts_diagram_0910_NIST_GCGP_fp.png) right before plt.show(), so a run produces files
...
plt.tight_layout()
plt.savefig("ph_diagram_0910_NIST_GCGP_fp.png", dpi=150)
...
plt.grid(True, ls=":")
plt.tight_layout()
plt.savefig("ts_diagram_0910_NIST_GCGP_fp.png", dpi=150)
