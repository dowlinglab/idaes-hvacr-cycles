...
Also added plt.savefig() calls for both diagrams (ph_diagram_0903data_NIST_GCGP_SPGPlabel.png,
ts_diagram_0903data_NIST_GCGP_SPGPlabel.png) right before plt.show(), so a run produces files
...
METHODS = [
    ...
    # DISPLAY LABEL ONLY: this is first_principle's data, NOT the historical
    # SPGP method/data. Relabeled per explicit request for slide continuity.
    # Values are the 09/03 (spgp_r32 (4).xlsx) delivery, taken verbatim from
    # phase_1_cubic_eos_validation_refstate_0903.py lines 141-144:
    #   Pc=4962000.0 Pa (49.62 bar), Tc=392.094 K, psat=4579.217 mmHg,
    #   Shomate A=32.5919 B=22.3913 C=602.645 D=-606.523 E=-0.0502453
    {"name": "SPGP", "Pc_bar": 49.62, "Tc": 392.094,
     "psat_pa": 4579.217 * 133.322,  # mmHg reading, converted to Pa
...
plt.tight_layout()
plt.savefig("ph_diagram_0903data_NIST_GCGP_SPGPlabel.png", dpi=150)
...
plt.grid(True, ls=":")
plt.tight_layout()
plt.savefig("ts_diagram_0903data_NIST_GCGP_SPGPlabel.png", dpi=150)
