...
Also added plt.savefig() calls for both diagrams (ph_diagram_0910_NIST_GCGP_SPGPlabel.png,
ts_diagram_0910_NIST_GCGP_SPGPlabel.png) right before plt.show(), so a run produces files
...
METHODS = [
    ...
    {"name": "SPGP", "Pc_bar": 60.921, "Tc": 355.615,  # DISPLAY LABEL ONLY: this is first_principle's data (09/10 fit), NOT the historical SPGP method/data. Relabeled per explicit request for slide continuity.
...
plt.tight_layout()
plt.savefig("ph_diagram_0910_NIST_GCGP_SPGPlabel.png", dpi=150)
...
plt.grid(True, ls=":")
plt.tight_layout()
plt.savefig("ts_diagram_0910_NIST_GCGP_SPGPlabel.png", dpi=150)
